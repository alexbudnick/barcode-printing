...
app.get("/", (req, res) => {
  res.json({
    ...
    note: "v1.0.4 adds serial number support and increases top/bottom safe margins for DYMO printing."
  });
});
...
app.get("/label", (req, res) => {
  ...
  const serial = clampText(req.query.serial || req.query.serialNumber || req.query.sn, 42);
  ...
  <style>
    ...
    */
    .safe-area {
      width: 3.22in;
      height: 0.945in;
      margin: 0.09in 0.22in 0.09in 0.06in;
      display: flex;
