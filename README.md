...
The page automatically opens the print dialog after loading. This v1.0.5 adds serial number support and increases the top/bottom safe margin to prevent DYMO clipping.
